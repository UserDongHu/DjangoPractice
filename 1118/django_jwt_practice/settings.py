"""
Django settings for django_jwt_practice project.
...
SECRET_KEY = 'django-insecure-!gu7@=m6n)f*_%_#4qr!dnf(5&j+osku#j$d#kql6-am3!y1u%'
...
ROOT_URLCONF = 'django_jwt_practice.urls'
...
WSGI_APPLICATION = 'django_jwt_practice.wsgi.application'
